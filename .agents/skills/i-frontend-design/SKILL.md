...
3. **Run teach-impeccable (REQUIRED)**: If neither source has context, you MUST run the i-teach-impeccable skill NOW before doing anything else. Do NOT skip this step. Do NOT attempt to infer context from the codebase instead.
